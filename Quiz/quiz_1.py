# A Compnay selling household appliances gives commision to it salsman depanding on the kind of the product sold as well as sale ammount
# Type       Commission
...
def main():
    ...
    while True:
        ...
        if commission is not None:
            print(f"Your commission: P{commission:.2f}")
