...
## what will be the python code to add "avocado" to the list?  *NOTE: please don't include any extra space in your answer

#listfruits= ["apple", "banana", "cherry", "orange", "kiwi", "melon", "mango"]
#listfruits.append ("avocado")
#print(listfruits)
...
## Assuming we have a list fruits = ["apple", "banana", "cherry", "orange", "kiwi", "melon", "mango"], 
## what will be the python code to change "apple" to "pineapple" from the list?  *NOTE: please don't include any extra space in your answer
...
## what will be the python code to arrange the fruits in alphabetical order?  *NOTE: please don't include any extra space in your answer
